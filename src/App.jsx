...
const Number = styled.div`
  ...
  width: calc(375px / 3 - 3 * 1.6rem);
  height: calc(375px / 3 - 3 * 1.6rem);
        ...
        <Numbers>
          <NumberContainer>
            <Number>
              <Top></Top>
              <Bottom></Bottom>
              <Text>{addLeadingZero(timeRemaining.days)}</Text>
          ...
          <NumberContainer>
            <Number>
              <Top></Top>
              <Bottom></Bottom>
              <Text>{addLeadingZero(timeRemaining.hours)}</Text>
              <CircleLeft></CircleLeft>
              <CircleRight></CircleRight>
            </Number>
            <TimeType>days</TimeType>
          ...
          <NumberContainer>
            <Number>
              <Top></Top>
              <Bottom></Bottom>
              <Text>{addLeadingZero(timeRemaining.minutes)}</Text>
              <CircleLeft></CircleLeft>
              <CircleRight></CircleRight>
            </Number>
            <TimeType>days</TimeType>
          ...
          <NumberContainer>
            <Number>
              <Top></Top>
              <Bottom></Bottom>
              <Text>{addLeadingZero(timeRemaining.seconds)}</Text>
              <CircleLeft></CircleLeft>
              <CircleRight></CircleRight>
            </Number>
            <TimeType>days</TimeType>
